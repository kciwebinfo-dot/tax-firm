...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <a class="active" href="<?= e(app_url('modules/dashboard/index.php')) ?>"><i class="fa-solid fa-chart-line"></i><span>Dashboard</span></a>
        ...
        <a href="<?= e(app_url('modules/profile/index.php')) ?>"><i class="fa-solid fa-user-gear"></i><span>Profile</span></a>
